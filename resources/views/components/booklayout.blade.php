...
<head>
    ...
    <style>
        ...
        .header-banner { width: 1000px; display: block; }
        .navbar { background-color: #ff5850; font-weight: bold; }
        .menu-wrap { display: flex; align-items: center; justify-content: center; width: 100%; }
        .nav-item a { color: #fff !important; padding: 0.5rem 1rem; }
        .list-book { display: grid; grid-template-columns: repeat(4, 24%); gap: 1.33%; margin-top: 15px; }
        .book { position: relative; margin: 10px; text-align: center; padding-bottom: 35px; }
        .btn-add-product { position: absolute; bottom: 0; width: 100%; }
        .cart-shortcut { position: absolute; top: 18px; right: 18px; min-width: 170px; display: flex; align-items: center; gap: 12px; padding: 12px 14px; color: #2f2a1f; background: rgba(255, 255, 255, 0.95); border-radius: 18px; box-shadow: 0 10px 24px rgba(0, 0, 0, 0.14); text-decoration: none !important; }
        .cart-shortcut:hover { color: #2f2a1f; transform: translateY(-1px); transition: all .2s ease; }
        .cart-icon-wrap { width: 42px; height: 42px; display: flex; align-items: center; justify-content: center; color: #fff; background: #ff6b57; border-radius: 14px; }
        .cart-copy { line-height: 1.1; }
        .cart-copy small { display: block; color: #8a7f6d; font-size: 12px; }
        .cart-copy strong { display: block; font-size: 15px; }
        .cart-badge { min-width: 24px; height: 24px; padding: 0 6px; display: flex; align-items: center; justify-content: center; color: #fff; background: #23b85c; border-radius: 999px; font-size: 12px; font-weight: bold; margin: 10px; text-align: center; }
...
<body style="background-color: #fff;">
    <header class="site-header" style="text-align:center">
        <div class="header-inner">
            <img src="{{ asset('hinh/banner_sach.jpg') }}" width="1000px" class="header-banner">
